...
router.post("/create_threads", threadsController_1.createThreads);
router.post("/like_thread", threadsController_1.likeThread);
router.post("/unlike_thread", verify_1.verify, threadsController_1.unlikeThread);
router.post("/create_comment", threadsController_1.createComment);
